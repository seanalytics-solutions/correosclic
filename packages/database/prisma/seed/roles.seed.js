...
function seedRoles(prisma) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, INITIAL_ROLES_1, role, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('🌱 Seeding roles...');
                    _i = 0, INITIAL_ROLES_1 = INITIAL_ROLES;
                    _a.label = 1;
                case 1:
                    if (!(_i < INITIAL_ROLES_1.length)) return [3 /*break*/, 4];
                    role = INITIAL_ROLES_1[_i];
                    data = {
                        codigo: role.codigo,
                        nombre: role.nombre,
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    console.log("\u2705 ".concat(INITIAL_ROLES.length, " roles procesados."));
                    return [2 /*return*/];
            }
        });
    });
